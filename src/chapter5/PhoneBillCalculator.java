package chapter5;
//Calculate the final total of someone's bill.
// Allow the operator to input the plan fee and overage minutes
//Charge the user 0.25 for every minute they were over their plan and 15% tax on the subtotal
//Create sep methods to cal tax, overage fees and and final total
